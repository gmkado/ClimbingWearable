...
import com.example.grant.wearableclimbtracker.login.SignInActivity;
...
public class MobileMainActivity extends AppCompatActivity
    ...
    protected void onStop() {
        ...
        if (logoutAfterClose) {
            /*
             * We need to call logout() here since onCreate() of the next Activity is already
             * executed before reaching here.
             *
             * NOTE: Unclear about why logoutAfterClose is necessary, but it was in the RealmTask example
             */
            MobileUserManager.logoutActiveUser(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem item;
        if(currItemId == -1 || currItemId > navigationView.getMenu().size()-1) {
            ...
            case R.id.nav_export:
                ...
                if (dirExists) {
                    ...
                    try {
                        ...
                        RealmResults<Climb> result = mRealm.where(Climb.class).findAll();
