...
/**
 * Created by Grant on 9/18/2017.
 */

import android.graphics.Color;
import android.graphics.Color;

/** FIXME: copy of ColorPalette from 'com.afollestad.material-dialogs:commons:0.9.4.6' so we can use the same colors in wearable*/
class ColorPalette {
